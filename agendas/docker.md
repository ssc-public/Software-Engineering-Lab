...
- یک سیستم که بر روی آن Docker  نصب شده باشد یا استفاده از ابزار‌های رایگان آزمایش داکر مانند [این](https://www.katacoda.com/courses/docker/playground) و [این](https://labs.play-with-docker.com).
