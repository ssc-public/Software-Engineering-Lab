...
- روش دوم (ارسال بسته به صورت Express) : در این حالت، بسته با سرعت بالا جابجا می‌شود و نحوه محاسبه‌ی قیمت بسته به صورت حاصل ضرب وزن بسته در 3.5 محاسبه می‌شود.
  ...
  - بسته در وضعیت ارسال (in Transition) است (در زمان تغییر به این وضعیت صرفا کافیست یک پیام چاپ شود).
...
- امکان تغییر وضعیت محصول نیز (از in Transotion به Delivered) وجود دارد.
