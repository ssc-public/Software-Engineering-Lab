...
### مسئله
با فرض وارد کردن دو عدد صحیح a و b به عنوان ورودی، نتیجه‌ی عملیات زیر به‌درستی نمایش داده شود:

$$ result = \sqrt{ \frac{a}{b} } $$
...
یک پوشه با عنوان studentID1-studentID2-BDD حاوی شماره دانشجویی اعضای گروه ایجاد نموده و کل پروژه را از طریق سامانه cw ارسال نمایید. آدرس مخزن پروژه خود را نیز در گزارش ذکر کنید. توجه کنید که مخزن شما عمومی (public) باشد.
