...
1. مفاهیم Dockerfile، image و container را با هم از نظر وظیفه‌ای که دارند مقایسه کنید.
2. از kubernetes برای انجام چه کارهایی می‌توان استفاده کرد؟ رابطه آن و داکر چیست.
