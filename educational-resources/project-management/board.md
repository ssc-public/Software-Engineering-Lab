...
# استفاده از بُرد برای مدیریت پروژه
...
### برد مدیریت پروژه
برای مدیریت بهتر وظایف در فرآیند ایجاد نرم‌افزار در متدولوژی اسکرام، استفاده از برد توصیه می‌شود. استفاده از این برد باعث می‌شود که دید بصری بهتری به روند انجام پروژه پیدا کنید.

## کار خواسته‌شده از شما
هر آزمایش از آزمایشگاه درس مهندسی نرم‌افزار را به‌مثابه‌ی یک sprint در متدولوژی اسکرام در نظر بگیرید. برای مدیریت بهتر وظایف در این sprint، از برد استفاده کنید.
...
- آشنایی شما دانشجویان با برد، چگونگی شکستن و تقسیم وظایف
